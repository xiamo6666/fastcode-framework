    ...
    public static Model convertModel(Model decisionTableModel) {
        ...
        if (StringUtils.isNotEmpty(decisionTableModel.getModelEditorJson())) {
            try {
                ...
                throw new RuntimeException(String.format("Error converting decision table %s to new model version", decisionTableModel.getName()));
            }
        }
    ...
    public static Model convertModelToV3(Model decisionTableModel) {
        ...
        if (StringUtils.isNotEmpty(decisionTableModel.getModelEditorJson())) {
            try {
                ...
                throw new RuntimeException(String.format("Error converting decision table %s to new model version", decisionTableModel.getName()), e);
            }
        }
