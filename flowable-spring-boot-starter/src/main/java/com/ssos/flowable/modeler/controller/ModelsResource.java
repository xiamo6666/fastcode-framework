...
import com.ssos.flowable.modeler.service.FlowableModelQueryService;
...
public class ModelsResource {
    ...
    public ModelRepresentation createModel(@RequestBody ModelRepresentation modelRepresentation) {
        ...
        Model newModel = modelService.createModel(modelRepresentation, json, null);
    ...
    protected void checkForDuplicateKey(ModelRepresentation modelRepresentation) {
        ...
        if (modelKeyInfo.isKeyAlreadyExists()) {
            throw new RuntimeException("Provided model key already exists: " + modelRepresentation.getKey());
        }
    }
    ...
    public ModelRepresentation duplicateModel(@PathVariable String modelId, @RequestBody ModelRepresentation modelRepresentation) {
        ...
        newModel = modelService.saveModel(newModel, newModel.getModelEditorJson(), imageBytes, false, newModel.getComment(), null);
    ...
    protected ObjectNode deleteEmbededReferencesFromBPMNModel(ObjectNode editorJsonNode) {
        try {
            ...
            throw new RuntimeException("Cannot delete the external references");
        }
    }
