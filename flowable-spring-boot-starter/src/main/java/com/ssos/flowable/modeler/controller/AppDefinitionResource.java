...
import com.ssos.flowable.modeler.model.AppDefinitionPublishRepresentation;
...
import com.ssos.flowable.modeler.service.AppDefinitionExportService;
import com.ssos.flowable.modeler.service.AppDefinitionImportService;
import com.ssos.flowable.modeler.serviceapi.AppDefinitionService;
...
public class AppDefinitionResource {
    ...
    public String importAppDefinitionText(HttpServletRequest request, @PathVariable String modelId, @RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            throw new RuntimeException("App definition could not be saved");
        }
