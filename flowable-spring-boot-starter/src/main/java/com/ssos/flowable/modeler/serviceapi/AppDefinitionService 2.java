...
import com.ssos.flowable.modeler.model.AppDefinitionUpDataResultRepresentation;
...
public interface AppDefinitionService {
    ...
    AppDefinitionUpDataResultRepresentation updateAppDefinition(String modelId, AppDefinitionSaveRepresentation updatedModel);
