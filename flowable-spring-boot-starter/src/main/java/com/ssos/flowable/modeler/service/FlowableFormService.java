...
import com.ssos.flowable.modeler.model.form.FormRepresentation;
...
public class FlowableFormService {
    ...
    public List<FormRepresentation> getForms(String[] formIds) {
        ...
        if (formIds == null || formIds.length == 0) {
            throw new RuntimeException("No formIds provided in the request");
        }
    ...
    public FormRepresentation saveForm(String formId, FormSaveRepresentation saveRepresentation) {
        ...
        if (modelKeyInfo.isKeyAlreadyExists()) {
            throw new RuntimeException("Model with provided key already exists " + formKey);
        }
        ...
        try {
            ...
            throw new RuntimeException("Form could not be saved " + formId);
        }
    ...
    protected FormRepresentation createFormRepresentation(AbstractModel model) {
        ...
        try {
            ...
            throw new RuntimeException("Could not deserialize form definition");
        }
