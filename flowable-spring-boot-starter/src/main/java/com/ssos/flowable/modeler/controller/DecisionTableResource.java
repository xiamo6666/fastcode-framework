...
import com.ssos.flowable.modeler.model.DecisionTableSaveRepresentation;
...
import com.ssos.flowable.modeler.service.FlowableDecisionTableService;
...
public class DecisionTableResource {
    ...
    public List<DecisionTableRepresentation> getDecisionTables(HttpServletRequest request) {
        ...
        if (decisionTableIds == null || decisionTableIds.length == 0) {
            throw new RuntimeException("No decisionTableId parameter(s) provided in the request");
        }
    ...
    public String importDecisionTableText(HttpServletRequest request, @RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            throw new RuntimeException("Error writing imported decision table representation json");
        }
        return json;
    }
