...
import com.ssos.flowable.modeler.model.ModelKeyRepresentation;
import com.ssos.flowable.modeler.model.ModelRepresentation;
...
public class ModelResource {
    ...
    public ModelRepresentation updateModel(@PathVariable String modelId, @RequestBody ModelRepresentation updatedModel) {
        ...
        if (modelKeyInfo.isKeyAlreadyExists()) {
            throw new RuntimeException("Model with provided key already exists " + updatedModel.getKey());
        }
        ...
        try {
            ...
            throw new RuntimeException("Model cannot be updated: " + modelId);
        }
    }
    ...
    public void deleteModel(@PathVariable String modelId) {
        ...
        try {
            ...
            throw new RuntimeException("Model cannot be deleted: " + modelId);
        }
    }
    ...
    public ModelRepresentation saveModel(@PathVariable String modelId, @RequestBody MultiValueMap<String, String> values) {
        ...
        try {
            ...
            throw new RuntimeException("Invalid lastUpdated date: '" + lastUpdatedString + "'");
        }

        Model model = modelService.getModel(modelId);
        User currentUser = null;
        boolean currentUserIsOwner = model.getLastUpdatedBy().equals("test");
    ...
    public ModelRepresentation importNewVersion(@PathVariable String modelId, @RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            throw new RuntimeException("Error reading file inputstream", e);
        }
    ...
    protected ModelRepresentation updateModel(Model model, MultiValueMap<String, String> values, boolean forceNewVersion) {
        ...
        try {
            ...
            throw new RuntimeException("Process model could not be saved " + model.getId());
        }
    }
    ...
    protected ModelRepresentation createNewModel(String name, String description, Integer modelType, String editorJson) {
        ...
        Model newModel = modelService.createModel(model, editorJson, null);
