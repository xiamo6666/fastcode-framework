...
public class AppDefinitionExportService extends BaseAppDefinitionService {
    ...
    public void exportAppDefinition(HttpServletResponse response, String modelId) throws IOException {
        ...
        if (modelId == null) {
            throw new RuntimeException("No application definition id provided");
        }
        ...
        try {
            ...
            for (Model decisionTableModel : decisionTableMap.values()) {
                ...
                try {
                    ...
                    throw new RuntimeException(String.format("Error converting decision table %s to XML", decisionTableModel.getName()));
                }
            }
            ...
            throw new RuntimeException("Could not generate app definition zip archive");
        }
    }
    ...
    public void createAppDefinitionBar(HttpServletResponse response, Model appModel, AppDefinitionRepresentation appDefinition) {
        ...
        try {
            ...
            throw new RuntimeException("Could not generate app definition bar archive");
        }
    }
    ...
    protected String createModelEntryJson(Model model) {
        ...
        try {
            ...
            throw new RuntimeException("Error exporting model json for id " + model.getId());
        }
