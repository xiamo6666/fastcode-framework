...
public class DictController {
    ...
    public Result<String> addDictIndex(@Validated DictIndexDTO dictIndexDto) {
    ...
    public Result<String> addDictInfo(DictInfoDTO dictInfoDto) {
        dictService.addDictInfo(dictInfoDto);
        return Result.success();
    }

    @GetMapping("/getDictInfoList")
    @Operation(summary ="获取查询字典值列表")
    public Result<List<DictInfo>> getDictInfoList(String dictIndexKey) {
        return Result.success(dictService.getDictInfoList(dictIndexKey));
    }
